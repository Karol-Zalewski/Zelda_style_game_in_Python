...
class Upgrade:
    ...
    def create_items(self):
        ...
        for index, item in enumerate(self.attribute_names):
            # Horizontal position
            ...
            # Create the object
            new_item = Item(left, top, self.width, self.height, index, self.font, item)
    ...
    def display(self):
        ...
        for index, item in enumerate(self.item_list):
            ...
            item.display(self.display_surface, self.selection_index, item.name, value, max_value, cost)


class Item:
    def __init__(self, l, t, w, h, index, font, name):
